...
//delete reviews and it's associated reviews and assigned reviews
  ...
  await User.findById(req.params.id)
    .then(async (user) => {
      ...
      try {
        ...
        await AssignedReviews.deleteMany({
          _id: { $in: user.assignedReviews },
        });
    ...
    await Reviews.create({
      ...
      await AssignedReviews.findByIdAndDelete(req.params.id).then(async () => {
        await User.findByIdAndUpdate(req.user.id, {
          $pull: { assignedReviews: req.params.id },
        }).then(() => {
...
//delete review from review model and review associated with user in user model in review array
